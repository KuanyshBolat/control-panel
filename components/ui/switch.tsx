  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={
          'bg-foreground/90 data-[state=checked]:bg-primary-foreground pointer-events-none block size-5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0.5'
        }
      />
    </SwitchPrimitive.Root>
  )
